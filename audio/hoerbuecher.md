...
4. Jetzt auf `Erweitert` klicken: Hier können alle Kästchen abgewählt werden. Nur `Abspielposition speichern` muss aktiviert werden! Die Drop-Down Menüs sind schon korrekt eingestellt.
